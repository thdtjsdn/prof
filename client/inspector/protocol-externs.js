...
/**
 * @param {function(?Protocol.Error, Array.<MemoryAgent.DOMGroup>):void=} opt_callback
 */
...
{
/** @type {string} */ this.text;
/** @type {string|undefined} */ this.source;
/** @type {string|undefined} */ this.sourceURL;
 ...
 * @param {function(?Protocol.Error, DebuggerAgent.Location):void=} opt_callback
 */
DebuggerAgent.getFunctionLocation = function(functionId, opt_callback) {}
/** @param {function(?Protocol.Error, DebuggerAgent.Location):void=} opt_callback */
DebuggerAgent.getFunctionLocation.invoke = function(obj, opt_callback) {}
